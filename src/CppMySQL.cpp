...
int CppMySQLDB::execDML(std::string& str)
{
	return execDML(str.c_str());
}
...
void CppMySQLStatement::bind(int nParam, std::string& str)
{
	bind(nParam, str.c_str());
}
...
{
	realBind(nParam - 1, MYSQL_TYPE_LONG, &nValue, sizeof(int));
}
